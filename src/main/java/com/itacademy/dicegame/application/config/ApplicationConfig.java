package com.itacademy.dicegame.application.config;
...
public class ApplicationConfig {
    ...
    public UserDetailsService userDetailsService() {
        return username -> playerPersistancePort.findByEmail(username)
                .orElseThrow(() -> new CustomAuthenticationException("Incorrect credentials"));
    }
